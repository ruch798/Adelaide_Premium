...
/***
 * Quarterly Sales Report Controller: To display Quarterly Sales Report
 */
public class QuarterlySalesReportController implements Initializable {
  ...
  /***
   * load Quartely Sales Chart
   */
  private void loadQuarterlySalesChart() {
    ...
    //        Previous Quarter Quantity Sold
