...
/***
 * Update Stock Quantity Controller
 */
public class UpdateStockQuantityController implements Initializable, ProductInterface {
  @FXML
   ...
   *
   * @param str
   * @return whether string has only digits
   */
  ...
  /** Add Product Button Click action */
  @FXML
  ...
  /** Add Quantity Button Click action */
  @FXML
