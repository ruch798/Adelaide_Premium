...
/***
 * Customer Demographic Report Controller: To display Customer demographic report
 */
public class CustomerDemographicReportController implements Initializable {

  private CustomerModel customerModel;

  @FXML private StackedBarChart<String, Number> stackedBarChart1, stackedBarChart2;
  ...
  private void loadCharts() {
    ...
    // stacked bar chart [gender] - customer demographics
    ...
    stackedBarChart1
        .getData()
        .addAll(series1, series2, series3, series4, series5, series6, series7, series8);

    // stacked bar chart [age] - customer demographics
    ...
    // pie chart [States Sales Distribution] - customer demographics
